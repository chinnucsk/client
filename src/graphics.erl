...
load_spr(File) ->
    ...
    {ok, <<_Ver:32/?UINT, TotalPics:16/?UINT>>} = file:pread(Device, bof, 6),
...
glBlitTexture(SX, SY, TextureNumber, Red, Green, Blue, Alpha) ->
    ...
    Size = config:get_value(sprite_size),
    gl:'begin'(?GL_QUADS),
    gl:texCoord2f(0, 0), gl:vertex2f(SX,     SY),
    gl:texCoord2f(1, 0), gl:vertex2f(SX+Size,SY),
    gl:texCoord2f(1, 1), gl:vertex2f(SX+Size,SY+Size),
    gl:texCoord2f(0, 1), gl:vertex2f(SX,     SY+Size),
    gl:'end'(),
